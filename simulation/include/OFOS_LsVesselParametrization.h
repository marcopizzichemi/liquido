...
#ifndef OFOS_LsVesselParametrization_h
#define OFOS_LsVesselParametrization_h 1
...
class OFOS_LsVesselParametrization : public G4VPVParameterisation
{
  public:

    OFOS_LsVesselParametrization(G4int    nModules,
    ...
    virtual ~OFOS_LsVesselParametrization();
